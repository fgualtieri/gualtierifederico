...
(() => {
  ...
  Webflow.require('ix').init([
    ...
    {"slug":"move-up-on-load-3","name":"move up on load 3","value":{"style":{"opacity":0,"x":"0px","y":"50px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"5%","stepsA":[{"wait":"300ms"},{"opacity":1,"transition":"transform 800ms ease 0, opacity 200ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
    ...
    {"slug":"move-left-on-load-1","name":"move left on load 1","value":{"style":{"opacity":0,"x":"-50px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"5%","stepsA":[{"wait":"100ms"},{"opacity":1,"transition":"transform 800ms ease 0, opacity 200ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
    {"slug":"move-left-on-load-2","name":"move left on load 2","value":{"style":{"opacity":0,"x":"-50px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"5%","stepsA":[{"wait":"200ms"},{"opacity":1,"transition":"transform 800ms ease 0, opacity 200ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
    {"slug":"move-left-on-load-3","name":"move left on load 3","value":{"style":{"opacity":0,"x":"-50px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"5%","stepsA":[{"wait":"300ms"},{"opacity":1,"transition":"transform 800ms ease 0, opacity 200ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}}
  ]);